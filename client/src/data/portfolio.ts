export const projects = [
  {
    ...
    technologies: [
      { name: "Java", color: "bg-orange-500/20 text-orange-300" },
  ...
  },
  {
    ...
    technologies: [
      { name: "OpenCV", color: "bg-green-500/20 text-green-300" },
  ...
  },
  {
    ...
    technologies: [
      { name: "Full Stack", color: "bg-purple-500/20 text-purple-300" },
